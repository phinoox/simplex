...
namespace Simplex.Gui.Control
{
	...
	public abstract class ControlBase : IDisposable
	{
		...
		public virtual void Dispose()
		{
			...
			Simplex.Gui.ToolTip.ControlDeleted(this);
		...
		protected virtual void OnMouseEntered()
		{
			...
			if (ToolTip != null)
				Simplex.Gui.ToolTip.Enable(this);
			else if (Parent != null && Parent.ToolTip != null)
				Simplex.Gui.ToolTip.Enable(Parent);
		...
		protected virtual void OnMouseLeft()
		{
			...
			if (ToolTip != null)
				Simplex.Gui.ToolTip.Disable(this);
		...
		{
			Platform.PlatformBase.SetCursor(m_Cursor);
		}
