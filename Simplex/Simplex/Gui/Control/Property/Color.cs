...
namespace Simplex.Gui.Control.Property
{
    /// <summary>
    /// Color property.
    /// </summary>
    public class Color : Text
    {
        ...
        private void SetTextFromColor(Simplex.Gui.Color color)
        {
            m_TextBox.Text = String.Format("{0} {1} {2}", color.R, color.G, color.B);
        }

        private Simplex.Gui.Color GetColorFromText()
        {
            ...
            return new Simplex.Gui.Color(alpha, red, green, blue);
        }
