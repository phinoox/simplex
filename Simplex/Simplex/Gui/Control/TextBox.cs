...
namespace Simplex.Gui.Control
{
	...
	public class TextBox : ControlBase
	{
		...
		protected override void OnPaste(ControlBase from, EventArgs args)
		{
			...
			InsertText(Platform.PlatformBase.GetClipboardText());
		}
		...
		protected override void OnCopy(ControlBase from, EventArgs args)
		{
			...
			Platform.PlatformBase.SetClipboardText(GetSelection());
		}
		...
		{
			m_LastInputTime = Platform.PlatformBase.GetTimeInSeconds();
		...
		protected override void Render(Skin.SkinBase skin)
		{
			...
			// Draw caret
			float time = Platform.PlatformBase.GetTimeInSeconds() - m_LastInputTime;
