...
namespace Simplex.Gui.Xml
{
	...
	public abstract class Component : IDisposable
	{
		...
		public object GetControl(string name)
		{
			...
			Simplex.Gui.Control.ControlBase control = null;
			if (m_View.Name == name)
				control = m_View;
			else
		...
		/// <remarks>No need to call the base implementation.</remarks>
		public virtual bool HandleEvent(string eventName, string handlerName, Simplex.Gui.Control.ControlBase sender, System.EventArgs args)
		{
			return false;
		}
