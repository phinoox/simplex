...
namespace Simplex.Gui.Xml
{
	public delegate Simplex.Gui.Control.ControlBase ElementHandler(Parser parser, Type type, Simplex.Gui.Control.ControlBase parent);
	...
	public class Parser : IDisposable
	{
		...
		static Parser()
		{
			...
			Assembly assembly = typeof(Simplex.Gui.Control.ControlBase).Assembly;
			if (assembly != null)
		...
		public Simplex.Gui.Control.ControlBase Parse(Simplex.Gui.Control.ControlBase parent)
		{
			Simplex.Gui.Control.ControlBase container = null;
		...
		public Simplex.Gui.Control.ControlBase ParseElement(Simplex.Gui.Control.ControlBase parent)
		{
		...
		/// <param name="parent">Parent control.</param>
		/// <returns>Control.</returns>
		public T ParseElement<T>(Simplex.Gui.Control.ControlBase parent) where T: Simplex.Gui.Control.ControlBase
		{
			Type type = typeof(T);
		...
		public void ParseAttributes(Simplex.Gui.Control.ControlBase element)
		{
		...
		/// </summary>
		/// <param name="parent">Parent control.</param>
		public void ParseContainerContent(Simplex.Gui.Control.ControlBase parent)
		{
		...
		private static Simplex.Gui.Control.ControlBase DefaultElementHandler(Parser parser, Type type, Simplex.Gui.Control.ControlBase parent)
		{
			Simplex.Gui.Control.ControlBase element = Activator.CreateInstance(type, parent) as Simplex.Gui.Control.ControlBase;
