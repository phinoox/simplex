...
using Simplex.Gui.Xml;
using Simplex.Platform;
using static global::Simplex.Platform.PlatformBase;

namespace Simplex.Gui.CommonDialog
{
	/// <summary>
	...
	public abstract class FileDialog : Component
	{
		...
		private void UpdateFolders()
		{
			...
			foreach (ISpecialFolder folder in Platform.PlatformBase.GetSpecialFolders())
			{
