...
namespace Simplex.Gui.Input
{
    ...
    public static class InputHandler
    {
		...
		public static void OnCanvasThink(ControlBase control)
        {
            ...
            float time = Platform.PlatformBase.GetTimeInSeconds();
            ...
            for (int i = 0; i < (int)Key.Count; i++)
            {
                ...
                {
                    m_KeyData.NextRepeat[i] = Platform.PlatformBase.GetTimeInSeconds() + KeyRepeatRate;
		...
		public static bool OnMouseClicked(ControlBase canvas, int mouseButton, bool down)
        {
            ...
            if (down &&
                ...
                (Platform.PlatformBase.GetTimeInSeconds() - m_LastClickTime[mouseButton]) < DoubleClickSpeed)
            {
                isDoubleClick = true;
            }
            ...
            {
                m_LastClickTime[mouseButton] = Platform.PlatformBase.GetTimeInSeconds();
        ...
        public static bool OnKeyEvent(ControlBase canvas, Key key, bool down)
        {
            ...
            if (down)
            {
                if (!m_KeyData.KeyState[iKey])
                {
                    ...
                    m_KeyData.NextRepeat[iKey] = Platform.PlatformBase.GetTimeInSeconds() + KeyRepeatDelay;
