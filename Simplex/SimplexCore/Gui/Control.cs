...
namespace Simplex.Core.Gui
{
    ...
    public class Control
    {
        ...
        private SimplexColor backgroundColor = new SimplexColor(Color4.Orange);
        private SimplexColor borderColor = new SimplexColor(Color4.Black);
        private float borderRadius = 0;
        private float borderThickness = 0;
        private Box2i bounds = new Box2i() { Max = new Vector2i( 50,20) };
        private bool enabled = true;
        private bool focused = false;
        private bool hovered = false;
        private string name;
        private bool scissorContents = true;
        private SimplexColor textColor = new SimplexColor(Color4.Black);
        ...
        /// </summary>
        public OpenTK.Mathematics.Box2i Bounds { get => bounds; set => bounds = value; }
        ...
        {
            get => bounds.Min.X;
            set { bounds.Min = new Vector2i(value,Top); OnPositionChanged(); }
        }
        ...
        {
            get => bounds.Min.Y;
            set { bounds.Min = new Vector2i(Left,value); OnPositionChanged(); }
        }
        ...
        {
            get => bounds.Size.X;
            set { bounds.Max = new Vector2i(Left + value,bounds.Max.Y); OnResized(); }
        }
        ...
        {
            get => bounds.Size.Y;
            set { new Vector2i(bounds.Max.X, Top + value); OnResized(); }
        }
        ...
        /// <returns></returns>
        public virtual bool ContainsPoint(Vector2i point)
        {
        ...
        {
            int relativeX = x - (int)bounds.Min.X;
            int relativeY = y - (int)bounds.Min.Y;
