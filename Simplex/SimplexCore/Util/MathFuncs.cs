    ...
    public static class MathFuncs
    {
        public static Quaternion RotationBetweenVectors(Vector3 start, Vector3 dest)
        {
            ...
            if (cosTheta < -1 + 0.001f)
            {
                ...
                rotationAxis = Vector3.Cross(WorldDefaults.Forward, start);
                if (rotationAxis.LengthFast < 0.01) // bad luck, they were parallel, try again!
                    rotationAxis = Vector3.Cross(WorldDefaults.Right, start);
        ...
        public static Quaternion Lookat(Vector3 position, Vector3 target)
        {
            ...
            Vector3 forward = WorldDefaults.Forward;// * -1f;
            Vector3 desiredUp =WorldDefaults.Up;
           ...
           // desiredUp = Vector3.Cross(right, destination);
            ...
            Vector3 newUp = rot1 * WorldDefaults.Up;
